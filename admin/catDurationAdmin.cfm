...
<body class="bg-dark">
    <cfoutput>
        ...
        <cfquery name="durationPack">
            select * from product where cName="Duration"
        </cfquery>
        ...
        <br>
            ...
            <h2 class="text-center bg-light">Duration Packages</h2>
        ...
        <script>
            ...
            var productNames = [
                <cfoutput query="durationPack">"#pName#"<cfif currentRow LT recordCount>,</cfif></cfoutput>
            ];
            var productRates = [
                <cfoutput query="durationPack">#pRate#<cfif currentRow LT recordCount>,</cfif></cfoutput>
            ];
