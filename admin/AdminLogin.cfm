          ...
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    <h2 class="h3">Admin Log In</h2>
                    <h3 class="fs-6 fw-normal text-secondary m-0">Enter Login details</h3>
                  </div>
                </div>
              </div>
              <form action="checkAdmin.cfm" name="getUser" method="POST">
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="passkey" class="form-control" name="passkey" id="passkey" value="" placeholder="passkey" required>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Not having account go with Admin Registration <a href="AdminRegistraion.cfm" class="link-dark text-decoration-none">Admin Registraion</a></p>
                  </div>
                </div>
              </div>
              <div class="row">
