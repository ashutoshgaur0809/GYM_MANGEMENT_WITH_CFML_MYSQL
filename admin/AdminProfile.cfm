...
<a href="../src/index.cfm?id=#url.id#"><i class="fa fa-arrow-left m-4" style="color: white;"></i></a>
                                      ...
                                      <cfloop query="durationPack">
                                          <tr>
                                              ...
                                              <td>*****<td>
                                                  ...
                                                  <button type="button" class="btn btn-warning"> <a href="UpdateAdminProfile.cfm?id=#id#" style="color: white; text-decoration:none">Update</a> </button>
