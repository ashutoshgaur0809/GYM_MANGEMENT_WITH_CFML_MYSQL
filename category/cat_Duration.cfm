    ...
    <div class="album mt-5 mx-auto">
      <div class="container-fluid">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          <!-- Card 1 -->
          <a href="checkout.cfm?btnid=1" style="text-decoration: none;">
          <div class="col">
            <div class="card shadow-sm ">
              <img src="/static/1m_1.jpg" class="card-img-top" alt="">
              <div class="card-body">
          ...
          <!-- Card 2 -->
          <a href="checkout.cfm?btnid=2" style="text-decoration: none;">
          <div class="col">
            <div class="card shadow-sm">
              <img src="/static/3m.png" class="card-img-top" alt="">
              <div class="card-body">
...
<button class="button-56" role="button" id="2">Buy Now</button>
        ...
        <a href="checkout.cfm?btnid=3" style="text-decoration: none;">
          <div class="col">
            <div class="card shadow-sm">
              <img src="/static/6m.png" class="card-img-top" alt="">
              <div class="card-body">
