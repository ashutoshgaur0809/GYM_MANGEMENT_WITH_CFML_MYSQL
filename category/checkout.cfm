...
<body class="bg-dark text-white">
    ...
    <cfquery name="packInfo">
        SELECT * 
        FROM product 
        WHERE pId = <cfqueryparam value="#btnid#" cfsqltype="cf_sql_integer">
    </cfquery>
                ...
                <div class="row g-5">
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        ...
                                        <small class="text-muted-custom">#packInfo.pName# Package</small>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        <h6 class="my-0">Product Category</h6>
                                        <small class="text-muted-custom">#packInfo.cName# Based</small>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        <h6 class="my-0">Product Rate</h6>
                                        <small class="text-muted-custom">#packInfo.pRate# INR</small>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between bg-body-tertiary">
                                    ...
                                    <span class="text-success">#packInfo.pRate * 0.90# INR</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Total (INR)</span>
                                    <strong>#packInfo.pRate * 0.90# INR</strong>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <div class="d-flex justify-content-between text-light">
                            ...
                            <button class="btn btn-primary btn-custom text-light" type="submit" name="submit"><a href="FinalCheckout.cfm?btnid=#btnid#"> Continue to checkout</a></button>
                        </div>
                    </div>
                </div>
            </form>
