...
<section class="bg-dark py-3 py-md-5 py-xl-8">
    <div class="container">
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Warning!</strong> Are you sure you want to register as an admin?
        ...
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-center text-bg-dark">
            ...
            <div class="col-12 col-xl-9">
              ...
              <img class="img-fluid rounded mb-4" loading="lazy" src="../static/logo.png" width="245" height="80" alt="GYM MS">
              ...
              <a href="register.cfm"><i class="fa-solid fa-arrow-left-long"></i></a>
            </div>
          </div>
        </div>
          ...
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    <h2 class="h3">Admin Registration</h2>
                    <h3 class="fs-6 fw-normal text-secondary m-0">Enter your details to register</h3>
                  </div>
                </div>
              </div>
              
              <form action="addAdmin.cfm" name="insertAdmin" method="post">
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="passkey" id="passkey" value="" placeholder="Passkey" value="#passkey#" required>
                      <label for="passkey" class="form-label">Admin Passkey</label>
                    </div>
                  </div>
                  <div class="col-12">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Already have an account with admin? 
                      <br>
                      <a href="admin/AdminLogin.cfm" class="link-dark text-decoration-none">Admin Log in</a></p>
                  </div>
                </div>
              </div>
              <div class="row">
